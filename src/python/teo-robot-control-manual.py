...
class CustomPropertyGroup(bpy.types.PropertyGroup):
    ...
    def updateLeftLegIk(self,context):
        if self.enableIkLeftLeg:
            bpy.context.object.pose.bones["FrontalLeftKnee"].constraints["IK"].mute = False # activate   
        else:
            bpy.context.object.pose.bones["FrontalLeftKnee"].constraints["IK"].mute = True  # deactivate
    ...
    sagittalLeftAnkle: bpy.props.FloatProperty(name='SagittalLeftAnkle', subtype='ANGLE', precision=4, min=math.radians(-42.5), max=math.radians(19.9), update=sagittalLeftAnkleUpdate)
    ...
    def updateRightLegIk(self,context):
        if self.enableIkRightLeg:
            bpy.context.object.pose.bones["FrontalRightKnee"].constraints["IK"].mute = False # activate   
        else:
            bpy.context.object.pose.bones["FrontalRightKnee"].constraints["IK"].mute = True  # deactivate
    ...
    frontalRightAnkle: bpy.props.FloatProperty(name='FrontalRightAnkle', subtype='ANGLE', precision=4, min=math.radians(-21.3), max=math.radians(25.4), update=frontalRightAnkleUpdate)
    sagittalRightAnkle: bpy.props.FloatProperty(name='SagittalRightAnkle', subtype='ANGLE', precision=4, min=math.radians(-19.9), max=math.radians(42.5), update=sagittalRightAnkleUpdate)
...
class OBJECT_OT_HomeRightLeg(bpy.types.Operator):
    ...
    def execute(self, context):
        bpy.context.object.pose.bones["RightLeg-TCP"].location = (0,0,0)
        bpy.context.object.pose.bones["RightLeg-TCP"].rotation_euler = (0,0,0)
        properties = bpy.context.scene.custom_props
...
class OBJECT_PT_TrunkControlPanel(bpy.types.Panel):
    ...
    def draw(self, context):
        ...
        layout.prop(context.scene.custom_props, 'joinIKtoLeftLeg')
        layout.prop(context.scene.custom_props, 'joinIKtoRightLeg')
